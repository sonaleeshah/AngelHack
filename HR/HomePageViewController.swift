...
class HomePageViewController: UIPageViewController {
    ...
    private(set) lazy var orderedViewControllers: [UIViewController] = {
        ...
        return [self.newHomeViewController("Home1"),
                self.newHomeViewController("Home2"),
                self.newHomeViewController("Home3")]
    }()
    ...
    override func viewDidLoad() {
        ...
        homeDelegate?.homePageViewController(self, didUpdatePageCount: orderedViewControllers.count)
    ...
    private func newHomeViewController(home: String) -> UIViewController {
        return UIStoryboard(name: "Main", bundle: nil) .
            instantiateViewControllerWithIdentifier("\(home)ViewController")
    }
    ...
    private func notifyTutorialDelegateOfNewIndex() {
        if let firstViewController = viewControllers?.first,
            ...
            homeDelegate?.homePageViewController(self, didUpdatePageIndex: index)
        }
    }
